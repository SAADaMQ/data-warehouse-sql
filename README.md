...
* after the warehouse was ready, I did some exploratory data analysis EDA to understand the data better. i explored the dimensions, dates, and key measures like total sales, total orders, and total customers.

* then I went deeper with advanced analytics. I did change over time analysis, cumulative analysis, performance analysis, part to whole analysis, and customer segmentation. at the end I built a customer report and a product report as views in the gold layer so anyone can query them easily.
