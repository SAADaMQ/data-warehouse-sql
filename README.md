...
Welcome to my project! so this is a data warehouse I built it from scratch. I think it is a great way to practice data engineering and ETL processes. 
...
* after the warehouse was ready, I did some EDA to explore the data and understand it better.
* then I went deeper with advanced analytics to find patterns and answer real business questions. at the end I built reports as views in the gold layer so anyone can query them easily.
